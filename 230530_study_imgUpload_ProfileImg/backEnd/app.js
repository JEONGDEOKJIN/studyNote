    ...
    // '사진 업로드' 관련 라우터 토스
        ...
        app.use("/img" , express.static(path.join(__dirname , "uploads")))
            ...
            // [2차 해석_230606]
                ...
                // <img src="http://localhost:8001/img/ad5191be-fea8-4398-b6a9-2d7e86c0e77c_1685429277257.jpg" alt="">  이렇게 작성하면 
                // ⭐GET 요청⭐ 이 들어가게 되는 것 이다. 
                // 그래서, 이 요청 url 을 보면, img 로 시작하므로 👉 이러한 것들은, 'uploads 폴더 가서 찾아!' 라고 말하는 거지. 
                // 다만, 미심쩍은 건, express.static(path.join : 이 기능을 아직 이해 못 하고 있다는 것 😥😥😥
