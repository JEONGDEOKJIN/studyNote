...
export class Wallet {
        ...
        constructor(privateKey : string = ""){
            ...
            if(privateKey == "")    // privateKey 키가 비어있다는 건 = 처음, 최초로 실행되었다는 의미로 추측할 수 있음. 
        ...
        // data 폴더 안에서, account 에 대응하는, privateKey 를 찾아서, 반환
        ...
        public getAccount() : string {
            // 총 130자리에서, 26자리 부터 끝까지를 계좌의 account 로 사용  
            return `0x${this.publicKey.slice(26).toString()}`   // 처음부터 25자리 까지는 제거
        }
            /*
                account 는 publicKey 에 의해 생기고 
                publicKey 는 privateKey 에 의해 생기고 
                privateKey 는 랜덤 으로 생겨남
            */
