...
// 머클트리 
    const data = ["A" , "B" , "C" , "D" , "E"];
        ...
        // 블록의 필수 요소 이고, 데이터들을 해시화 해서, 더 한 후, 해시화 반복 
        // 트리 처럼 뻗어서, 마지막 루트 해시값을 구해서 사용한다. 

        // 만약, 중간에 C 값이 변화 하면 -> B 랑 C 더한 값이 변화하고, C 와 D 가 더한 값이 변화 됨 
        // 루트? 자체가 변화 ? ❓❓❓❓❓❓ 
        // 그래서 변화 되었다는 걸 알게 됨 
    ...
    // 맞는지 확인하고 싶으면?
        ...
        // 다만, 해시화를 들고 있다가, 정확한 값인지 확인하고 싶으면, 해시화 해서
